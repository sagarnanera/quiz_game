...
{
	system("color ");// to add background and fourground colour
...
mainhome:
	...
	printf("     C PROGRAM QUIZ GAME BY ID NO. : 20CP020, 20CP035 & 20CP043\n");
...
void help()
{
	...
	printf("\n\n                              HELP");
	printf("\n ------------------------------------------------------------");
	printf("\n    C program Quiz Game by ID NO. : 20CP020, 20CP035 & 20CP043\n\n");
